...
namespace SLAM.Reborn {
  public partial class App : Application {
    ...
    private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e) {
      ...
      new WarningWindow("An unexpected error occurred. Details have been logged to crash.log.\n\n" + e.Exception.Message, "OK", null, "SLAM Crash").ShowDialog();
      e.Handled = true;
    }
    private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e) {
      LogCrash(e.ExceptionObject as Exception, "CurrentDomain_UnhandledException");
      Dispatcher.Invoke(() => {
        new WarningWindow("A critical error occurred. Details have been logged to crash.log.\n\n" + e.ExceptionObject, "OK", null, "SLAM Critical Error").ShowDialog();
      });
    }
